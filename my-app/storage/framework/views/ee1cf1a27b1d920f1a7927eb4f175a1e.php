<div class="header-area">
    ...
    <nav>
                        <ul id="navigation">
                            <li><a href="<?php echo e(route('index')); ?>">Ana səhifə</a></li>
                            <li><a href="<?php echo e(route('about')); ?>">Haqqımızda</a></li>
                            <li><a href="<?php echo e(route('services')); ?>">Xidmətlər</a></li>
                            <li><a href="<?php echo e(route('products')); ?>">Məhsullar</a>

                            </li>

                            <ul class="submenu">
                                <li><a href="<?php echo e(route('blog')); ?>">Blog</a></li>
                                <li><a href="<?php echo e(route('blog')); ?>">Element</a></li>
...
<?php /**PATH C:\Users\Ali\Desktop\Final-laravel-Project\my-app\resources\views/Front/inc/header.blade.php ENDPATH**/ ?>